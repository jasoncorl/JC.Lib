<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PagerDemoFrm2.aspx.cs" Inherits="JC.Web.UI.UserControl.Demo.PagerDemoFrm2" %>

<%@ Register Assembly="JC.Web.UI.UserControl" Namespace="JC.Web.UI.UserControl" TagPrefix="cc1" %>
...
<body style="margin-top: 2px;">
  <form id="form1" runat="server">
    <table id="PageTitle" cellspacing="0" cellpadding="0" width="100%" border="0">
      <tr onclick="SearchShow(this.childNodes[0].childNodes[0])" style="cursor: hand">
    ...
    <div>
      ...
      <cc1:WPager ID="WPager1" runat="server" OnPageChanged="WPager1_PageChanged" AlwaysShow="true" SubmitButtonText="转到" TextAfterInputBox="页">
      </cc1:WPager>
    </div>
  </form>
</body>
