  ...
  public class WPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
  {
    ...
    protected override void RenderContents(HtmlTextWriter writer)
    {
      ...
      if (PageCount <= 1 && !AlwaysShow)
        return;
      writer.Write("<FONT style='FONT-SIZE: 10pt; COLOR: #0000cc' face='宋体'>");
      ...
      if ((ShowInputBox == ShowInputBox.Always) || (ShowInputBox == ShowInputBox.Auto && PageCount >= ShowBoxThreshold))
      {
        ...
        //ResourceManager rm = new ResourceManager("Corl.UserControl.ImgRes", typeof(ImgRes).Assembly);
        ...
        //global::Corl.UserControl.ImgRes.PagerSubmit
        ...
        writer.AddAttribute(HtmlTextWriterAttribute.Style, "BACKGROUND-ATTACHMENT: fixed; font-size:9pt; ");
